 ...
 * 
 */
@WebServiceClient(name = "AlipayPayServiceImplService", targetNamespace = "http://serviceImpl.alipay.com/", wsdlLocation = "http://sangto.oicp.net/alipay/AlipayPayService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://sangto.oicp.net/alipay/AlipayPayService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://sangto.oicp.net/alipay/AlipayPayService?wsdl', retrying as a local file");
